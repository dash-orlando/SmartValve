...
def get_array( array_queue, NSENS=4 ):
    ...
    try:
        ...
        if (len(col) == NSENS*3+1):                                         # 3 readings/sensor + 1 distance reading
            #
            ...
            ToF_dist = int( col[12] )                                       # Distance readings
...
global ToF_dist; ToF_dist = 0                                               # Used to store ToF height readings
